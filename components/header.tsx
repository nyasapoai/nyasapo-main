...
export function Header() {
  ...
  const isDashboard = pathname.startsWith("/dashboard") || pathname.startsWith("/ai-models") || pathname.startsWith("/ai-assistant") || pathname.startsWith("/library") || pathname.startsWith("/settings") || pathname.startsWith("/analytics")
    ...
    <header className="sticky top-0 z-50 w-full border-b border-[#e2e2e2] bg-white">
      <div className="flex h-16 items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button className="bg-[#2563eb] hover:bg-[#004fcb] text-white font-medium">
            Access
          </Button>
        </div>
      </div>
